...
namespace Ceemas.DataAccess.Core.SqlStatementBuilder.Visitors
{
    ...
    public class SelectStatementElementVisitorTest
    {
        ...
        public void SelectTest()
        {
            ...
            var selectElement = Element.SelectStatement(new FromStatementElement[] { fromStatementElement }, null, null, null, null);

            var sqlBuilder = new SqlStringBuilder();
            var columnElementVisitor = new ColumnElementVisitor(sqlBuilder, true);
            var expressionVisitor = new ExpressionElementVisitor(sqlBuilder, columnElementVisitor);
        ...
        public void SelectMultiFromTest()
        {
            ...
            var selectElement = Element.SelectStatement(new FromStatementElement[] { fromStatementElement1, fromStatementElement2 }, null, null, null, null);
        ...
        public void SelectJoinTest()
        {
            ...
            var selectElement = Element.SelectStatement(new FromStatementElement[] { fromStatementElement1 }, new JoinStatementElement[] { joinStatementElement1 }, null, null, null);
