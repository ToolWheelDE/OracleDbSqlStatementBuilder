...
namespace Ceemas.DataAccess.Core.SqlStatementBuilder.Builder
{
    public class SelectStatementBuilder
    {
        ...
        public SelectStatementBuilder GroupBy(Action<GroupByColumnBuilder> columns)
        {
            var columnBuilder = new GroupByColumnBuilder();
            columns?.Invoke(columnBuilder);

            SelectGroupByElement = Element.GroupByStatement(columnBuilder.ColumnElements);
        ...
        internal GroupByStatementElement SelectGroupByElement { get; private set; }
